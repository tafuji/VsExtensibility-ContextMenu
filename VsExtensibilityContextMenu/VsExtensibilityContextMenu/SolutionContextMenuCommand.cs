...
namespace VsExtensibilityContextMenu
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SolutionContextMenuCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("efb373fd-946a-4e0e-b192-6f25368373b2");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SolutionContextMenuCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private SolutionContextMenuCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static SolutionContextMenuCommand Instance
        {
            get;
            private set;
        }
